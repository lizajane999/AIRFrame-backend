...
sub doBooleanOr {
#Lisa checked, working 4/6/10
    my $self = shift;
    my $query = shift;
    my $element1 = shift;
    my $element2 = shift;
    my $presults = shift;
    #print "in BooleanOR<br />";
	...
	for my $id (keys %{$$presults{$element2}{$lit}}) {
	 # print "id = ".$id."<br />";
		...
		if ($aux ne "") {
		    $$presults{$element1}{$lit}{$id}{$field} = $aux;
		   # print "adding aux = ".$aux."<br />";
		} else {
		    delete $$presults{$element1}{$lit}{$id}{$field};
		    #print "deleting aux = ".$aux."<br />";
		}
	    }
	}
    }
