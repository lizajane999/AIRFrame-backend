...
sub savetofile {
    ...
    my $self = shift;
    my $filename = shift;
# print "Inside save to file <br />";
# print "Saving to $filename <br />";
# print "Contents of type: ";
# print @{$self->{type}};
# print "<br />";
    open (OUT, ">$filename");
...
#   my $l = 0;
#   my $count = 0;
  ################### had to add this to make files work right first time ####################
  $/ = "\n";
#   print "Inside read from file <br />";
#   print "opening :". $filename."<br />";
#   open (IN, "<$filename");
#   $count += tr/\n/\n/ while sysread(IN, $_, 2 ** 16);
#   print "Number of lines: $count <br />";
#   close(IN);
