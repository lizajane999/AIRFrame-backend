...
use constant DB_ROOT => '/home/lizajane999/public_html/textpresso/tdb/';
use constant DB_TMP => '';
use constant DB_STOPWORDS => '/home/lizajane999/public_html/textpresso/misc/stopwords';
...
#use constant DB_ROOT => '/var/www/html/celegans/tdb/';
#use constant DB_TMP => '/tmp/textpresso/';
#use constant DB_STOPWORDS => '/var/www/html/celegans/misc/stopwords';

#use constant DB_LITERATURE => { 'C. elegans' => 'celegans/'
			#	};

#use constant DB_LITERATURE_DEFAULTS => ['C. elegans'];
